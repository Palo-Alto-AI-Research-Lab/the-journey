...
- **[claude-consensus](https://github.com/Palo-Alto-AI-Research-Lab/claude-consensus)** — the flagship: multi-machine agent consensus you can reproduce in 15 minutes (offline demo, evals, FAILURE-MODES.md).
