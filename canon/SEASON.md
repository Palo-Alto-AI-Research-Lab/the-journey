# 🎬 SEASON 1 — Сезон 1 — Не-кодер + AI-кофаундер

## Вопрос сезона
**Возьмут ли не-кодера с AI-кофаундером на работу в LLM-компанию (Anthropic/OpenAI)?**

## Премиса
Антон, фаундер без программистского прошлого, строит с Claude фабрику контента и рой агентов, честно и на публику, чтобы траст превратился в подписчиков → заказчиков ИЛИ оффер.
...
- `followers_delta`: трек с этой недели
- `posts_sent`: трек с этой недели
- `clients`: 0
- `arc_days`: 0
---
